...
const funFacts = [
    ...
    },
    {
        ...
        text: `
            ...
            for the pupils, and it would be very interesting. I wanted to engage with them and learn how they come
    ...
    },
    {
        ...
        text:  `
            I've been following and listening to a lot of industry leaders and experts, and I've been amazed by 
            the insights and the perspectives they share. I believe that speaking at technical conferences would not 
            only be a great opportunity for me to learn from other industry experts, but it would also allow me master my craft and
            to give back to the community that has been very rewarding. I'm confident that I would have valuable insights 
            and experiences to share, and I'm excited to start exploring speaking opportunities in the near future
            That's why I am giving a tech talk at my countries DevFest this year in December.
        `,
